...
boolCalc (Reln cOp expr1 expr2) = liftA2 (opLookup cOp relnOps) (intCalc expr1) (intCalc expr2)
boolCalc (BBin op expr1 expr2) = liftA2 (opLookup op bBinOps) (boolCalc expr1) (boolCalc expr2)
boolCalc (BUn op expr) = fmap (opLookup op bUnOps) (boolCalc expr)

intCalc :: AExpr -> IntCalc
intCalc (Var v) = retrieveEnv v
intCalc (IntConst val) = return val
intCalc (ABin op expr1 expr2) = liftA2 (opLookup op aBinOps) (intCalc expr1) (intCalc expr2)
intCalc (AUn op expr) = fmap (opLookup op aUnOps) (intCalc expr)
